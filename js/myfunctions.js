...
function c(toConsole) {
     var styles = [
         ...
         'font-family: Overpass', 'font-size: 12px'
     ].join(';');
    console.log(`%c` + toConsole, styles);
}

function cy(toConsole) {
    var styles = [
        // 'font-size: 30px', 'font-family: Times New Roman,Times, serif ,
        'color: gold','font-family: Overpass', 'font-size: 1.5vh'
    ].join(';');
    console.log(`%c` + toConsole, styles);
}
...
function cr(toConsole) {
    var styles = [
        // 'font-size: 30px', 'font-family: Times New Roman,Times, serif ,
        'color: red','font-family: Overpass', 'font-size: 1.5vh'
    ].join(';');
    console.log(`%c` + toConsole, styles);
}
...
function cb(toConsole) {
    var styles = [
        // 'font-size: 30px', 'font-family: Times New Roman,Times, serif ,
        'color: blue','font-family: Overpass', 'font-size: 1.5vh'
    ].join(';');
    console.log(`%c` + toConsole, styles);
}
...
function cw(toConsole) {
    var styles = [
        // 'font-size: 30px', 'font-family: Times New Roman,Times, serif ,
        'color: white','font-family: Overpass', 'font-size: 1.5vh'
    ].join(';');
    console.log(`%c` + toConsole, styles);
}
...
function cbig(toConsole) {
    var styles = [
        // 'font-size: 40px', 'font-family: Times New Roman,Times, serif ,
        'color: yellow','font-family: Overpass', 'font-size: 2vh'
    ].join(';');
    console.log(`%c` + toConsole, styles);
}
...
//  document.getElementById(`timeStamp`).innerHTML = moment().format('MMMM Do, YYYY [at] h:mm a');
...
const theba = "rgba(55, 66, 76, 1)";
const theGreen = "rgba(0, 173, 43, 1)";
const theRed = "rgba(194, 47, 51, 1)";
const theOrange = "rgba(255, 103, 0, 1)";
const theYellow = "rgb(221, 172, 94)";
const theGray = "rgb(78, 92, 107)";
const theBackground = "rgba(229, 231, 239, 1)";
const theDarkGray = "rgba(43, 50, 56, 1)";
const theBrown = "rgba(69, 48, 22, 1)";
      
const bitByBitRed = "rgba(240, 44, 80, 1)";
      const bitByBitBlue = "rgba(0, 79, 136, 1)";
      const bitByBitBlonde = "rgba(241, 227, 214, 1)";